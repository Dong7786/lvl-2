...
if(arg0.getSource() == firstButton || arg0.getSource() == secondButton) {
	playJeopardyTheme();
}
		JButton buttonPressed = (JButton) arg0.getSource();
		// If the buttonPressed was the firstButton
		if(arg0.getSource() == firstButton) {
			askQuestion("How do you know when it's 7 hours after an car crash?", "when the ambulance comes", 1000);
		}
...
if(arg0.getSource() == secondButton) {
	askQuestion("What is the word for 'a fear of long words?'", "Hippopotomonstrosesquippedaliophobia", 100000);
}
	...
	private void askQuestion(String question, String correctAnswer, int prizeMoney) {
		...
		String Q1 = JOptionPane.showInputDialog(null, question);
